...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionText.setText("What is the capital of Uruguay?");
        option1.setText("Asunción");
        option2.setText("Montevideo");
        option3.setText("La Paz");
        option4.setText("Accra");
